...
import image3 from "../../../assets/images/about1.png";
import image4 from "../../../assets/images/about1.png";
import image5 from "../../../assets/images/about1.png";
import image6 from "../../../assets/images/about1.png";
      ...
      <div className="contain flex flex-col items-start justify-center h-full relative z-10">
        <div className="flex flex-col items-start justify-start gap-5 w-full">
          ...
          <div className="flex items-center gap-3 flex-wrap sm:flex-row">
            ...
            <button className="border outline-none py-1 px-2 rounded-2xl text-sm">
              sdxcfvhg
            </button>
          </div>
        </div>
