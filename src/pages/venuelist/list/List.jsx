...
import Venuelist2 from '../../../component/venuelist/Venuelist2'
...
const filters = [
  {
    ...
    options: [
      ...
      { value: 'Mumbai', label: 'Mumbai', checked: true },
  ...
  {
    id: 'Select Your Formate',
    name: 'Select Your Formate',
    options: [
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Event venues</h1> 
