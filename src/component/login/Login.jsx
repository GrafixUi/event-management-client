  ...
  const onSubmit = async (e) => {
    ...
    try {
      const newUser = await axios.post(
        `${process.env.REACT_APP_BACKENDURL}/auth/local`,
        {
          identifier,
          password,
        }
          ...
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 shadow-sm shadow-slate-500 rounded-3xl">
            <div className="flex flex-col items-stretch  w-[48%] max-md:w-full max-md:ml-0 bg-[#1D275F] rounded-l-3xl max-sm:hidden">
              <div className="flex flex-col my-auto max-md:max-w-full max-md:mt-10">
                ...
                <Link
                  to="/register"
                  className="text-blue-950 text-center text-base font-bold whitespace-nowrap bg-white self-center justify-center items-stretch mt-6 px-12 py-3.5 rounded-[45px] max-md:px-5"
                >
                  Sign up
                </Link>
              </div>
                ...
                <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 ">
                  <div className="flex flex-col items-stretch max-md:w-full max-md:ml-0 ">
                    <div className="flex-col overflow-hidden relative flex min-h-[48px] grow py-12 max-md:max-w-full max-sm:-mt-10 max-sm:p-4">
                      ...
                      <button
                        type="button"
                        className="relative w-52 text-white text-sm font-bold leading-5 tracking-normal bg-stone-950 self-stretch justify-center items-stretch mt-6 px-8 py-4 rounded-xl max-md:max-w-full max-md:px-5"
                        onClick={onSubmit}
                      >
                        Login
                      </button>
