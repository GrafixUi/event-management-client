                ...
                <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 shadow-sm shadow-slate-500 rounded-3xl">
                    <div className="flex flex-col items-stretch w-[48%] max-md:w-full max-md:ml-0 bg-[#1D275F] rounded-l-3xl">
                        <div className="flex flex-col my-auto max-md:max-w-full max-md:mt-10">
                            ...
                            />
                            <div className="text-white text-center text-6xl font-semibold tracking-[5.2px] uppercase self-center max-w-[274px] mt- max-md:text-4xl max-md:mt-10">
                                ...
                                <div className="flex flex-col items-stretch max-md:w-full max-md:ml-0">
                                    <div className="flex-col overflow-hidden relative flex min-h-[756px] grow py-12 max-md:max-w-full">
                                        ...
                                        <div className="relative flex flex-col items-stretch ml-9 self-start max-md:ml-2.5 max-md:mt-10">
                                            ...
                                            <input className="justify-center text-zinc-400 text-base leading-6 mt-10 max-md:mt-10 border border-[#E5E5E5] pr-40 pl-2 py-3 rounded-md" type='text' placeholder='Username or Email *' />

                                            <input className="justify-center text-zinc-400 text-base leading-6 mt-10 max-md:mt-10 border border-[#E5E5E5] pr-40 pl-2 py-3 rounded-md" type='text' placeholder='Your password *' />
                                        </div>
