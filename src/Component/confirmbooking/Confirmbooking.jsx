        ...
        <div>
            <div className="bg-white flex flex-col justify-center items-center px-16 py-12 max-md:px-5">
                <div className="flex w-full max-w-[1452px] flex-col mt-10 max-md:max-w-full max-md:my-10">
                    ...
                    />
                    <div className="text-green-600 text-3xl font-medium self-center mt-10 max-md:max-w-full">
                                    ...
                                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                                        <div className="flex flex-col items-stretch w-[61%] max-md:w-full max-md:ml-0">
                                            <div className="flex flex-col my-auto max-md:max-w-full max-md:mt-10">
                                                <div className="text-white text-4xl font-semibold self-stretch max-md:max-w-full">
                                                    Booking Detail
                                                </div>
                                                <div className="text-white text-2xl font-medium leading-8 self-stretch mt-8 max-md:max-w-full">
                                                    Schedule
                                                </div>
                                                <div className="text-white text-lg leading-7 self-stretch mt-7 max-md:max-w-full">
                                                    Movie Title
                                                </div>
                                                <div className="text-white text-2xl font-medium leading-8 self-stretch mt-1.5 max-md:max-w-full">
                                                ...
                                                <div className="text-white text-2xl font-semibold self-stretch mt-7 max-md:max-w-full">
                                                    HITEX Exhibition Centre
                                                </div>
                                                <div className="text-white text-lg font-light self-stretch mt-5 max-md:max-w-full">
