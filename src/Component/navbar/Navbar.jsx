                    ...
                    <div className="flex grow basis-[0%] flex-col items-stretch max-md:max-w-full">
                        <div className="flex w-full items-stretch justify-between gap-5 max-md:max-w-full max-md:flex-wrap">
                            <Link to="/">
                                ...
                                /></Link>
                            <input className="bg-white flex gap-4 pl-8 py-3 w-[550px] rounded-3xl border-l-stone-300 border-y-stone-300 border border-none self-start items-start max-md:max-w-full max-md:flex-wrap max-md:px-5" type='text' placeholder='What event are you looking for today?' />
                            <img
                                loading="lazy"
                                src="https://cdn.builder.io/api/v1/image/assets/TEMP/3d33a891fae5f17b24199cc9e0896d75af3c9dd205130969a03bcc4d394462bc?" alt='img'
                        ...
                        <div className="flex w-full items-start justify-between gap-5 mt-5 max-md:max-w-full max-md:flex-wrap">
                            <div className="flex-col overflow-hidden self-stretch relative flex aspect-[5.354838709677419] items-stretch gap-1.5 px-3 py-2">
                                <img
                                    loading="lazy"
                                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/00492f6bb241f746b7077950cb81e15f1b9703090fe8ff016a38b3651dc10197?" alt='img'
                                    className="absolute h-full w-full object-cover object-center inset-0"
                                />
                                <img
                                    loading="lazy"
                                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/107117cb6f7149fa46fd5d916ea6701ee32a8d16e75d1b8811076d65de102c4b?" alt='img'
                                ...
                                <img
                                    loading="lazy"
                                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/93dae0c53ba4b2700f0cc88f3a2dc0352d1442d944c30ec4e6f9629cf3115bf0?" alt='img'
                            ...
                            <Link to="/eventslist" className="text-white text-xs leading-6 self-center my-auto">
                                Events
                            </Link>
                            <Link to="/movieslist" className="text-white text-xs leading-6 self-center my-auto">
                                Movies
                            </Link>
