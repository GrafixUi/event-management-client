            ...
            <div className="flex w-full max-w-[1668px] flex-col items-center mt-4 max-md:max-w-full">
                <div className="self-stretch flex items-start justify-between gap-5 max-md:max-w-full max-md:flex-wrap">
                    <img
                        ...
                        className="aspect-[3.49] object-contain object-center w-96 overflow-hidden mt-6 self-start max-md:max-w-full"
                    />
                    ...
                    <div className="flex grow basis-[0%] flex-col items-stretch self-start max-md:max-w-full">
                        ...
                        <div className="flex max-w-[733px] justify-center items-stretch mt-7">
