                                    ...
                                    <div className="flex flex-col items-stretch max-md:w-full max-md:ml-0">
                                        <div className="flex-col overflow-hidden relative flex min-h-[300px] grow py-12 max-md:max-w-full">
                                            ...
                                            <div className="relative flex flex-col items-stretch ml-9 self-start max-md:ml-2.5 max-md:mt-10">
                                                ...
                                                <input className="justify-center w-80 text-zinc-400 text-base leading-6 mt-5 max-md:mt-10 border border-[#E5E5E5] pr-40 pl-2 py-3 rounded-md" type='text' placeholder='UserName' />

                                                <input className="justify-center w-80 text-zinc-400 text-base leading-6 mt-5 max-md:mt-10 border border-[#E5E5E5] pr-40 pl-2 py-3 rounded-md" type='text' placeholder='Email' />

                                                <input className="justify-center w-80 text-zinc-400 text-base leading-6 mt-5 max-md:mt-10 border border-[#E5E5E5] pr-40 pl-2 py-3 rounded-md" type='text' placeholder='password' />
                                                <input className="justify-center w-80 text-zinc-400 text-base leading-6 mt-5 max-md:mt-10 border border-[#E5E5E5] pr-40 pl-2 py-3 rounded-md" type='text' placeholder='confirm password' />
                                            </div>
